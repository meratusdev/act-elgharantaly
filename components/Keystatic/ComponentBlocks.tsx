...
export const ComponentBlocks = {
  ...
  //         href: props.fields.href.value as string,
  ...
  //       externalLink={{
  //         href: props.fields.externalLinkHref.value as string,
  ...
  // //   label: "YouTube Embed",
  // //   preview: (props) => (
  // //     <YouTubeEmbed youtubeLink={props.fields.youtubeLink.value as string} />
  // //   ),
  // //   schema: {
  ...
  //   label: "Tweet Embed",
  //   preview: (props) => (
  //     <TweetEmbed tweet={props.fields.tweet.value as string} />
  //   ),
  //   schema: {
  //     tweet: fields.url({
  //       label: "Tweet URL",
  ...
  //       socialLink={props.fields.socialLink.value as string}
  //     />
  //   ),
  //   schema: {
  //     quote: fields.text({
